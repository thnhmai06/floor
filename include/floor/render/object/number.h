#pragma once
#include "floor/render/object/string.h"
...
namespace Floor::Render::Object
{
	...
	public:
		...
		void update() override
		{
			...
			const auto rounded_number = Floor::Utilities::Math::round(*number * multiply, decimal_format);
			const auto [integer_part, decimal_part] = Floor::Utilities::Math::decimal_separate(rounded_number);
