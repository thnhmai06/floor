...
namespace Floor::Events::Timing
{
	...
	public:
		...
		int64_t make_point(const std::optional<Uint64>& current_tick = std::nullopt) noexcept;
		[[nodiscard]] int64_t get_last_point() const noexcept;
